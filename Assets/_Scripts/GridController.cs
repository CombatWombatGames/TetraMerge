...
public class GridController : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    void Merge(Vector2Int[] area, Vector2Int beginPosition, Vector2Int endPosition)
    {
        ...
        AnimationSystem.ShakeField(gridView.Field, area.Length, gridView.DustParticles, gridView.ShardsParticles, gridView.CellSize, gridView.LeafParticles, gridView.LeafParticlesBurst);
    }
}